...
mkdir -p $HOME/MrX-Theme/Song 
mv Access-Granted.mp3  sound_effect.py $HOME/MrX-Theme/Song
rm 1
mkdir -p $HOME/MrX-Theme/NETWORK
mv network.py $HOME/MrX-Theme/NETWORK
